...
% Step 6: Loop through the game till lives left. Refactorcode and remove
% redundant lines of code. Show whether user wins or loses. 
...
numLives = 7;
current_word_stage = rand_word;

% set the current_word_stage -- all blanks
...
while (gameIsOn)
    ...
    if length(correctGuesses) == length(rand_word)   
        % user wins
        userWins = 1;
